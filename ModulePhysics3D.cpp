...
bool ModulePhysics3D::CleanUp()
{
	...
	p2List_item<btCollisionShape*>* shape_iterator = shape_list.getFirst();
	p2List_item<btRigidBody*>* body_iterator = body_list.getFirst();

	while (shape_iterator != NULL || body_iterator != NULL)
	{
		if (shape_iterator != NULL)
		{
			delete shape_iterator->data;
			shape_iterator = shape_iterator->next;
		}
		if (body_iterator != NULL)
		{
			delete body_iterator->data->getUserPointer();
			delete body_iterator->data;
